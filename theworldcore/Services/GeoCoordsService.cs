...
namespace theworldcore.Services
{
    public class GeoCoordsService
    {
        ...
        public async Task<GeoCoordsResult> GetCoordsAsync(string name)
        {
            ...
            var apiKey = @"AIzaSyDOQ_L-NkLEgwnFBL40sFeYiXQ3ltwqfNc"; //config["Keys:BingKey"];
            var encodedName = WebUtility.UrlEncode(name);
            var url = $"https://maps.googleapis.com/maps/api/geocode/outputFormat?json&key={apiKey}&address={encodedName}";
